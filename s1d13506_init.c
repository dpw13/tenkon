...
static struct s1d13xxxfb_regval s1d13xxxfb_initregs[] = {
	...
	{0x0010,0x00},	// Memory Clock Configuration Register: CLKI no divide
	{0x0014,0x10},	// LCD Pixel Clock Configuration Register: 2:1 divide, CLKI 
	{0x0018,0x00},	// CRT/TV Pixel Clock Configuration Register
	{0x001C,0x00},	// MediaPlug Clock Configuration Register
	{0x001E,0x01},	// CPU To Memory Wait State Select Register
	{0x0020,0x00},	// Memory Configuration Register: EDO-DRAM with 2-CAS
	{0x0021,0x45},	// DRAM Refresh Rate Register: self-refresh 20 kHz
	{0x002A,0x12},	// DRAM Timings Control Register 0: EDO 50ns 20 MHz MCLK (can be sped up)
	{0x002B,0x02},	// DRAM Timings Control Register 1: see above
	...
	{0x01FC,0x02},	// Display Mode Register(0x01:LCD, 0x02:CRT, 0x03:LCD&CRT)
};

const int reg_count = sizeof(s1d13xxxfb_initregs)/sizeof(struct s1d13xxxfb_regval);

void s1d13506_init(uint8_t *base) {
    for (int i=0; i<reg_count; i++) {
        uint16_t offset = s1d13xxxfb_initregs[i].addr;
        uint8_t val = s1d13xxxfb_initregs[i].value;
        base[offset] = val;
    }
}